...
| **gpu_count**       | The number of GPUs available on the system.                                     | `[infrastructure](components.2)nbComponent = IC12` |
| **gpu_model**       | The model name of the GPU used for the training (if applicable).                | `[infrastructure](components.2)componentName = IC11` |
| **longitude**       | The longitude of the location where the training was executed.                  | `[environment]longitude = E3`                |
| **latitude**        | The latitude of the location where the training was executed.                   | `[environment]latitude = E2`                 |
